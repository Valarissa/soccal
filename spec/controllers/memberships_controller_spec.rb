  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved membership as @membership" do
        ...
        post :create, {:membership => { "role_id" => "invalid value" }}, valid_session
        assigns(:membership).should be_a_new(Membership)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested membership" do
        ...
        Membership.any_instance.should_receive(:update_attributes).with({ "role_id" => "1" })
        put :update, {:id => membership.to_param, :membership => { "role_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the membership as @membership" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Membership.any_instance.stub(:save).and_return(false)
        put :update, {:id => membership.to_param, :membership => { "role_id" => "invalid value" }}, valid_session
        assigns(:membership).should eq(membership)
      end
